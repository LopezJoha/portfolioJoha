    ...
    <div
      ...
      <motion.div
        ...
        <form
          ...
          className='bg-bgCard bg-cover bg-no-repeat bg-center w-[400px] h-[600px] mt-12 flex flex-col gap-5 p-10 rounded-lg shadow-[0_10px_20px_rgba(139,_60,_127,_0.3)]'>
